...
export default function ChatPanel({ messages, isLoading, isMockMode, onSendMessage, onClearChat }) {
  ...
  return (
    <aside className="chat-panel">
      ...
      <div className="chat-input-area">
        <form className="chat-input-form" onSubmit={handleSubmit}>
          ...
          <div className="chat-input-actions">
            ...
            <div className="chat-input-buttons-group">
              <button
                type="button"
                className={`btn btn-ghost mic-btn ${isTranscriberOpen ? 'active' : ''}`}
                onClick={() => setIsTranscriberOpen(prev => !prev)}
                title="Gravar reunião / Usar Microfone"
                disabled={isLoading}
              >
      ...
      {/* Drawer de Gravação e Transcrição */}
      <MeetingTranscriber
